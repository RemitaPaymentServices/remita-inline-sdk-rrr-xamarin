...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "remita-inline-sdk-rrr-xamarin.Android.dll" comes first in this list. */
		"remita-inline-sdk-rrr-xamarin.Android.dll",
		"FormsViewGroup.dll",
		"remita-inline-sdk-rrr-xamarin.dll",
